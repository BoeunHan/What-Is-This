...
public class Window_graph : MonoBehaviour
{
	...
	private void Start()
	{
		...
		List<int> valueList = new List<int>() { 30, 35, 58, 66, 70, 80, 88, 0 };
		List<int> valueList1 = new List<int>() { 0, 0, 0, 0, 40, 42, 60, 0 };
		List<int> valueList2 = new List<int>() { 0, 0, 0, 0, 0, 20, 46, 0 };
	...
	private void ShowGraph(List<int> valueList, ColorSet color)
	{
		...
		for (int i = 0; i < valueList.Count; i++)
		{
			...
			if (lastCircleGameObject != null && valueList[i] != 0)
			{
